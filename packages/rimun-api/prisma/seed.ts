...
async function main() {
  await prisma.forum.createMany({
    data: [
      { acronym: "GA", name: "General Assembly" },
      { acronym: "ECOSOC", name: "Economic and Social Council" },
      { acronym: "HRC", name: "Human Rights Council" },
      { acronym: "SC", name: "Security Council" },
      { acronym: "ICJ", name: "International Court of Justice" },
      { acronym: "CC", name: "Crisis Committee" },
      { acronym: "HSC", name: "Historical Security Council" },
    ],
  });
  ...
  await prisma.role.createMany({
    data: [
      ...
      { group_id: 1, name: "President of the General Assembly" },
      { group_id: 1, name: "President of the Eco.So.C." },
      { group_id: 1, name: "President of the Human Rights Council" },
      { group_id: 1, name: "President of the Security Council" },
      { group_id: 1, name: "President of the Historical Security Council" },
      {
        group_id: 1,
      ...
      { group_id: 1, name: "Head of ICJ" },
      { group_id: 4, name: "Vice President of the Human Rights Council" },
      { group_id: 4, name: "Vice President of the Security Council" },
      {
        group_id: 4,
      ...
      { group_id: 6, name: "President of the ICJ" },
      { group_id: 6, name: "Vice President of the ICJ" },
